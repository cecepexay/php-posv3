...
switch($_GET[act]){
  ...
  default:
    ...
    echo "<h2>Manajemen Modules</h2><hr>
          ...
          <br><table id='sortby' class='btn btn-info'><thead>
  ...
  case "tambahmodul":
    ...
    echo "<form  class='uniform' method=POST action='$aksi?module=modul&act=input'>
          ...
          <dt><label>Status</label></dt>     <dd> : <label><input type=radio name='status' value='admin' checked>Administrator</label>
                                                    <label><input type=radio name='status' value='pegawai'>Pegawai</label></dd>
          </dl>
          <div class='buttons'>
  ...
  case "editmodul":
    ...
    if ($r[status]=='pegawai'){
      echo "<dt><label>Status</label></dt>       <dd> : <label><input type=radio name='status' value='pegawai' checked>Pegawai</label>
                                                        <label><input type=radio name='status' value='admin'> Administrator</label>
                                                 </dd>";
    }
    else{
      echo "<dt><label>Status</label></dt>       <dd> : <label><input type=radio name='status' value='pegawai'>Pegawai</label>
